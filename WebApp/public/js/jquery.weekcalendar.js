  ...
  $.widget('ui.weekCalendar', (function() {
    ...
    return {
      options: {
        ...
        shortMonths: ['Jan', 'Feb', 'Mar', 'Avr', 'Mai', 'Juin', 'Jui', 'Aou', 'Sep', 'Oct', 'Nov', 'Dec'],
        longMonths: ['Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Decembre'],
...
/* REMOVE CURRENT DAY
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          if (calEvent.action == '1')
          eventClass += ' allumer';
          else if (calEvent.action == '2')
          eventClass += ' veille';
...
/*
 * REMOVE DE LA DATE
 *+ (options.headerSeparator) + this._formatDate(date, options.dateFormat);*/
      },
